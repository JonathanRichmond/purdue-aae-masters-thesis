...
arc instead of using a staging orbit, not to be confused with direct patched conic transfers
...
Sun-Earth dynamics until it reaches the Earth SoI in \cref{fig:directE}(b). Note that this
...
total maneuver cost of $5.544$ km/s with a total time-of-flight of $3.26$ years.
...
manifold arcs before staging in a Sun-Earth $L_{2}$ halo orbit. After using the orbit to properly
phase, the transfers depart from the system along a Sun-Earth unstable invariant manifold arc.
\begin{enumerate}
