...
\end{equation}
For every feasible $\theta_{b_{int}}$ then, there are two possible phasing solutions ($\omega_{a}$)
for $\theta_{a_{int}}$:
\begin{equation}
...
\cref{eq:arrivalperiapse} is dependent on the orientation of the arrival conic, which in turn is
