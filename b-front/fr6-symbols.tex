\begin{symbols}
    ...
    $\tilde{n}$& Normalized mean motion\cr
    ...
    $\rhodot$& Rotating velocity\cr
    $\rhobar$& Rotating position vector in $\mathbb{R}^{3}$\cr
    $\rhobardot$& Rotating velocity vector in $\mathbb{R}^{3}$\cr
    $\tau$& Time\cr
